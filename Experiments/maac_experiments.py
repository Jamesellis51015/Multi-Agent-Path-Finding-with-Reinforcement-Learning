...
def maac_2A2t(): 
    ...
    parmeter_grid1 = {
       ...
       # "entropy_coeff":[0.0],
        ...
        "env": ["independent_navigation-v0"],
        "step_r": [-0.1], #[-0.1, -0.4],
        "obstacle_collision_r": [-0.02],#[-0.4], #[-0.015],
        "agent_collision_r":  [-0.2], #[-1.0],
        "goal_reached_r": [0.3], #[0.1],
        "finish_episode_r": [2.0] #[2.0]
    }
...
def maac_4_3_1():
    ...
    parmeter_grid1 = {
       ...
       # "entropy_coeff":[0.0],
        ...
        "env": ["independent_navigation-v0"],
        "step_r": [-0.1], #[-0.01, -0.1, -0.4],
        "obstacle_collision_r": [-0.02], #[-0.015],
        "agent_collision_r": [-0.2], #[-1.0], 
        "goal_reached_r": [0.3], #[0.1],
        "finish_episode_r": [2.0]
    }

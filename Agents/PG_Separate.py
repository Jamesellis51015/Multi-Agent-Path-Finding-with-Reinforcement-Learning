...
class PG_Separate(nn.Module):
    ...
    def __init__(self, args, observation_space, action_space):
        ...
        self.entropy_coefficient = self.args.entropy_coeff
        self.value_ceofficient = self.args.value_coeff
    ...
    def update(self, transitions_batch, per_agent = True):
        ...
        n_agents = torch.tensor(len(processed_batch.keys())).double().to(config.device)
        ...
        total_value_loss /= n_agents
        total_action_loss /= n_agents
